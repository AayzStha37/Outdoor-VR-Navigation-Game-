...
[CreateAssetMenu(menuName = "Outdoor VR game/Audio Clip Randomizer")]
public class TapSoundAudioClipRandomizer : ScriptableObject
{
    [SerializeField]
    ...
    public static implicit operator AudioClip(TapSoundAudioClipRandomizer v)
    {
